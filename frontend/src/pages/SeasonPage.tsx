            ...
            <div className="lg:col-span-3 space-y-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-surface-1 border border-white/[0.06] rounded-lg pl-9 pr-4 py-2.5 text-sm text-gray-200 placeholder-gray-500 focus:outline-none focus:border-arcade-cyan/40 focus-visible:ring-2 focus-visible:ring-arcade-cyan/30 transition-colors"
                />
              </div>
